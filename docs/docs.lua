      ...
      funcs = {
        {
          ...
          returns = ret_or_fail('uv_prepare_t', 'prepare'),
        },
        {
          name = 'prepare_start',
      ...
      funcs = {
        {
          ...
          returns = ret_or_fail('uv_check_t', 'check'),
        },
        {
          name = 'check_start',
      ...
      funcs = {
        {
          ...
          returns = ret_or_fail('uv_idle_t', 'idle'),
        },
        {
          name = 'idle_start',
      ...
      funcs = {
        ...
        },
        {
          ...
          params = {
            { name = 'udp', type = 'uv_udp_t' },
            { name = 'data', type = 'buffer' },
            { name = 'host', type = 'string', desc = 'or `nil`' },
            { name = 'port', type = 'integer', desc = 'or `nil`' },
            cb_err(nil, true),
          },
          returns = success_ret,
          -- LuaLS needs '?' to type-check nil-only parameters. Neither checker can
          -- distinguish these required nil placeholders from omitted arguments.
          overloads = {
            'fun(udp: uv.uv_udp_t, data: uv.buffer, host?: nil, port?: nil, callback: fun(err: string?)?): 0?, string?, uv.error_name?',
          },
        },
        {
          name = 'udp_try_send',
          ...
          overloads = {
            'fun(udp: uv.uv_udp_t, data: uv.buffer, host?: nil, port?: nil): integer?, string?, uv.error_name?',
          },
        },
        {
          name = 'udp_try_send2',
        ...
        },
        {
          ...
          returns = success_ret,
          overloads = {
            'fun(udp: uv.uv_udp_t, host?: nil, port?: nil): 0?, string?, uv.error_name?',
          },
        },
      },
    },
