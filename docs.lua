...
--- @alias Doc.Type string|Doc.Type.Fun|Doc.Type.Table
...
--- @param ty string|Doc.Type.Table
--- @param name string
...
local function async_cb(args)
  args = args or {{'success', 'boolean|nil'}}
  return cb_err(
    args,
    true,
    '(async if provided, sync if `nil`)'
  )
end
      ...
      { title = '`uv_loop_t` - Event loop',
        ...
        methods = {
          ...
          { name = 'run',
            ...
            params = {
              { name = 'mode', type = 'string|nil', default = '"default"' }
            },
      ...
      { title = '`uv_handle_t` - Base handle',
        ...
        methods = {
          ...
          { name = 'send_buffer_size',
            ...
            params = {
              { name = 'handle', type = 'uv_handle_t' },
              { name = 'size', type = 'integer|nil', default = '0' }
            },
        ...
        methods = {
          ...
          { name = 'poll_start',
            ...
            params = {
              ...
              { name = 'events', type = 'string|nil', default = '"rw"' },
              {
                name = 'callback',
                type = {
                  'function',
        ...
        methods = {
          ...
          { name = 'spawn',
            ...
            params = {
              ...
              { name = 'options', type = 'table', desc = '(see below)' },
              { name = 'on_exit',
                type = { 'function', { 'code', 'integer' }, { 'signal', 'integer' } },
              }
            },
            returns = {
              {'uv_process_t', 'handle'},
          ...
          { name = 'process_kill',
            ...
            params = {
              ...
              { name = 'signame', type = 'string|integer|nil', default = 'sigterm' }
            },
            returns = success_ret
          },
          { name = 'kill',
      ...
      { title = '`uv_tcp_t` - TCP handle',
        ...
        methods = {
          { name = 'new_tcp',
            ...
            params = {
              { name = 'flags', type = 'string|integer|nil' }
            },
          ...
          { name = 'socketpair',
            ...
            params = {
              { name = 'socktype', type = 'string|integer|nil', default = 'stream' },
              { name = 'protocol', type = 'string|integer|nil', default = '0' },
              { name = 'flags1',
                type = { 'table', optional = true, { 'nonblock', 'boolean' } }
              },
              { name = 'flags2',
                type = { 'table', optional = true, { 'nonblock', 'boolean' } }
              },
      ...
      { title = '`uv_pipe_t` - Pipe handle',
        ...
        methods = {
          { name = 'new_pipe',
            ...
            params = {
              { name = 'ipc', type = 'boolean|nil', default = 'false' }
            },
          ...
          { name = 'pipe',
            ...
            params = {
              { name = 'read_flags',
                type = { 'table', optional = true, { 'nonblock', 'boolean', 'false' } }
              },
              { name = 'write_flags',
                type = { 'table', optional = true, { 'nonblock', 'boolean', 'false' } }
              },
          ...
          { name = 'pipe_bind2',
            ...
            params = {
              { name = 'pipe', type = 'uv_pipe_t' },
              { name = 'name', type = 'string' },
              { name = 'flags', type = 'integer|table|nil', default = '0' }
            },
            returns = success_ret,
            notes = {
              [[
      ...
      { title = '`uv_tty_t` - TTY handle',
        ...
        methods = {
          ...
          { name = 'tty_get_winsize',
            ...
            returns = ret_or_fail('integer, integer', 'width, height'),
          },
        ...
        methods = {
            ...
            params = {
              ...
              { name = 'flags',
                type = {
                  'table',
                  optional = true,
                  { 'ipv6only', 'boolean|nil' },
                  { 'reuseaddr', 'boolean|nil' }
                }
              }
            },
            returns = success_ret,
          ...
          { name = 'udp_set_membership',
            ...
            params = {
              ...
              { name = 'interface_addr', type = 'string|nil' },
          ...
          { name = 'udp_try_send2',
            ...
            params = {
              { name = 'udp', type = 'uv_udp_t' },
              { name = 'messages', type = '{ [string]: { data: string, addr: { id: string, port: integer } } }' },
              { name = 'flags', type = '0|{}|nil' },
              { name = 'port', type = 'integer' }
            },
          ...
          { name = 'fs_event_start',
            ...
            params = {
              ...
              { name = 'path', type = 'string' },
              {
                ...
                type = {
                  'table',
                  { 'watch_entry', 'boolean|nil', 'false' },
                  { 'stat', 'boolean|nil', 'false' },
                  { 'recursive', 'boolean|nil', 'false' }
                }
              },
              cb_err({
                {'filename', 'string'},
                {'events', {'table', {'change', 'boolean|nil'}, {'rename', 'boolean|nil'}} }
              })
            },
            returns = success_ret
          },
        ...
        methods = {
          ...
          { name = 'fs_poll_start',
            ...
            params = {
              ...
              cb_err({
                { 'prev', 'table|nil', '(see `uv.fs_stat`)' },
                { 'curr', 'table|nil', '(see `uv.fs_stat`)' }
              })
            },
            returns = success_ret
          },
          ...
          methods = {
            ...
            },
            {
              ...
              params = {
                ...
                { name = 'mode', type = 'integer', desc = "(octal `chmod(1)` mode, e.g. `tonumber('644', 8)`)" },
                async_cb({ { 'fd', 'integer|nil' } })
              },
            ...
            },
            {
              ...
              params = {
                ...
                { name = 'offset', type = 'integer|nil' },
                async_cb({ { 'data', 'string|nil' } })
              },
            ...
            },
            {
              ...
              params = {
                { name = 'template', type = 'string' },
                async_cb({ { 'fd', 'integer|nil' }, {'path', 'string|nil'} })
              },
              -- TODO(lewis6991): wrong, (fd, path) is returned as a vararg
              returns_sync = {
                { 'integer|nil', 'fd' },
                { 'string|nil', 'path' },
                { 'string|nil', 'err' },
            ...
            },
            {
              ...
              params = {
                { name = 'path', type = 'string' },
                cb_err( { { 'success', 'uv_fs_t|nil' } }, true)
              },
            ...
            -- fs_stat.result
            {
              ...
              params = {
                { name = 'path', type = 'string' },
                async_cb({ { 'stat', 'fs_stat.result|nil' } })
              },
            ...
            },
            {
              ...
              params = {
                { name = 'path', type = 'string' },
                { name = 'mode', type = 'string', desc = "(a combination of the `'r'`, `'w'` and `'x'` characters denoting the symbolic mode as per `chmod(1)`)" },
                async_cb({ { 'permission', 'boolean|nil' } })
              },
            ...
            },
            {
              ...
              params = {
                { name = 'path', type = 'string' },
                { name = 'new_path', type = 'string' },
                { name = 'flags', type = 'integer|{ dir: boolean|nil, junction: boolean|nil }|integer|nil' },
                async_cb()
              },
              returns_sync = ret_or_fail('boolean', 'success'),
              returns_async = 'uv_fs_t'
            ...
            },
            {
              ...
              params = {
                ...
                {
                  name = 'flags',
                  type = '{ excl: boolean|nil, ficlone: boolean|nil, ficlone_force: boolean|nil }|integer|nil',
                },
                async_cb()
              },
              returns_sync = ret_or_fail('boolean', 'success'),
            ...
            },
            {
              ...
              params = {
                { name = 'path', type = 'string' },
                async_cb({ { 'dir', 'luv_dir_t|nil' } }),
                { name = 'entries', type = 'integer|nil' }
              },
            ...
            },
            {
              ...
              params = {
                ...
                async_cb({{'entries', '{ name: string, type: string }[]|nil'}})
              },
            ...
            },
            {
              ...
              params = {
                { name = 'path', type = 'string' },
                async_cb({ { 'stat', 'fs_statfs.result|nil' } })
              },
      ...
      { title = 'DNS utility functions',
        ...
        methods = {
          { name = 'getaddrinfo',
            ...
            params = {
              { name = 'host', type = 'string|nil' },
              { name = 'service', type = 'string|nil' },
              { name = 'hints',
                type = {
                  'table',
                  { 'family', 'string|integer|nil' },
                  { 'socktype', 'string|integer|nil' },
                  { 'protocol', 'string|integer|nil' },
                  { 'addrconfig', 'boolean|nil' },
                  { 'v4mapped', 'boolean|nil' },
                  { 'all', 'boolean|nil' },
                  { 'numerichost', 'boolean|nil' },
                  { 'passive', 'boolean|nil' },
                  { 'numericserv', 'boolean|nil' },
                  { 'canonname', 'boolean|nil' },
                },
                optional = true
              },
              async_cb( { { 'addressess', 'table|nil' } })
            },
            returns_sync = ret_or_fail(
              '{ addr: string, family: string, port: integer, socktype: string, protocol: string, canonname: string }[]|nil',
              'addresses'
            ),
          ...
          { name = 'getnameinfo',
            ...
            params = {
              ...
              async_cb({{'host', 'string|nil' }, { 'service', 'string|nil'}})
            },
            returns_sync = ret_or_fail('string, string', 'host, service'),
      ...
      { title = 'Miscellaneous utilities',
        ...
        methods = {
          ...
          { name = 'getrusage',
            ...
            returns = ret_or_fail('table', 'rusage'),
            returns_doc = [[
              `table` or `fail`
          ...
          { name = 'getpid',
            desc = '**Deprecated:** Please use `uv.os_getpid()` instead.',
            returns = 'integer'
          },
          { name = 'getuid',
          ...
          { name = 'interface_addresses',
            ...
            returns = '{ [string] : { ip: string, family: string, netmask: string, internal: boolean, mac: string } }',
            returns_doc = [[
              `table`
              - `[name(s)]` : `table`
                - `ip` : `string`
          ...
          { name = 'os_uname',
            ...
            returns = '{ sysname: string, release: string, version: string, machine: string }',
          },
          { name = 'os_gethostname',
          ...
          { name = 'os_getenv',
            ...
            params = {
              { name = 'name', type = 'string' },
              { name = 'size', type = 'integer|nil', default = 'LUA_BUFFERSIZE' }
            },
          ...
          { name = 'os_tmpdir',
            desc = 'Returns the temporary directory.',
            returns = ret_or_fail('string', 'path'),
            warnings = { 'This function is not thread-safe.' }
          },
          { name = 'os_get_passwd',
      ...
      { title = 'Metrics operations',
        ...
        methods = {
          ...
          { name = 'metrics_info',
            ...
            returns = '{ loop_count: integer, events: integer, events_waiting: integer }'
          }
        }
      },
