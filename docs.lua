        ...
        methods = {
          ...
          },
          {
            ...
            params = {
              { name = 'path', type = 'string' },
              { name = 'new_path', type = 'string' },
              { name = 'flags', type = '{ dir: boolean|nil, junction: boolean|nil }|integer|nil' },
              async_cb(),
            },
            returns_sync = ret_or_fail('boolean', 'success'),
            returns_async = 'uv_fs_t',
        ...
        methods = {
          {
            ...
            params = {
              {
                name = 'work_callback',
                -- TODO(lewis6991): can also be string
                type = {
                  'function',
        ...
        methods = {
          {
            ...
            params = {
              ...
              async_cb({ { 'addresses', 'addresses|nil' } }),
            },
            returns_sync = ret_or_fail('addresses', 'addresses'),
        ...
        methods = {
          ...
          },
          {
            ...
            params = {
              ...
              { name = 'get_old_affinity', type = 'boolean|nil' },
            },
            -- TODO(lewis6991): can also return boolean
            returns = ret_or_fail(
              { 'dict', 'integer', 'boolean' },
              'affinity'
            ),
          },
          {
            ...
            params = {
              { name = 'thread', type = 'luv_thread_t' },
              { name = 'mask_size', type = 'integer|nil' },
            },
            returns = ret_or_fail(
              { 'dict', 'integer', 'boolean' },
              'affinity'
