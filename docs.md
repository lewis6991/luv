...
**Returns (sync version):** `integer` or `nil`, `string` or `nil`, `string` or `nil`, `string` or `nil`
...
**Returns:** `string` or `nil`, `string`, `string` or `nil`
...
- `path`: `string`
- `new_path`: `string`
- `flags`: `integer` or `{ dir: boolean` or `nil, junction: boolean` or `nil }` or `integer` or `nil`
- `callback`: `callable` or `nil` (async if provided, sync if `nil`)
  - `err`: `nil` or `string`
  - `success`: `boolean` or `nil`
...
**Returns (sync version):** array of `table` or `fail`
- `name`: `string`
- `type`: `string`
